...
2. ```ssh-keygen -t rsa```
3. Press ```ENTER``` to store the key in the default folder /Users/inasekin/.ssh/id_rsa).
...
``` Your identification has been saved in /Users/inasekin/.ssh/id_rsa.
Your public key has been saved in /Users/inasekin/.ssh/id_rsa.pub.
The key fingerprint is:
ae:89:72:0b:85:da:5a:f4:7c:1f:c2:43:fd:c6:44:30 inasekin@mac.local
...
server {
 listen 80;
 server_name nasekinid.com www.nasekinid.com;
...
server {
  listen 80;
  server_name admin.nasekinid.com;
  location / {
